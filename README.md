...
> **Status: v0.4.1** — MCP tool results are now schema-valid for strict
...
> Reporter interface for JSON/NDJSON output, a branded DMG with
> drag-to-Applications for the macOS app, and a refreshed runtime dependency
> (gopsutil v4.26.7). Cross-platform (macOS, Linux, Windows).
